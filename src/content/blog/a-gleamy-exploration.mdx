...
If you want to learn more about Gleam, you can check out the [official docs](https://gleam.run/) and the [language tour](https://gleam.run/book/), they're both very good and will get you started in no time. If you are interested in the project I have been building with Gleam, you can check it out [here](https://github.com/raeeceip/noht.gleam)
